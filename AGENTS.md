...
3. Do not call `gh pr create` until the description has been checked against the template.
4. After creation, inspect the published pull request body and correct any missing sections.
