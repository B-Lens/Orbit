...
symbol's periodic Binance Futures ticker stream. Stale updates pause
price-dependent checks while the WebSocket reconnects; REST is reserved for a
missing or invalid cached price. The sentiment cron
