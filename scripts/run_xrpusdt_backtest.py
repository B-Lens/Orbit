#!/usr/bin/env python3
"""Backtest XRPUSDT hourly candles with conservative execution assumptions."""
...
from orbit.strategies.xrpusdt_strategy import XRPUSDTStrategy  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    report = WalkForwardBacktester(
        ...
        fee_rate=0.0004,
        slippage_bps=2.0,
    ).run(data, symbol="XRPUSDT", warmup_bars=250)
    result = {
        "strategy": "XRPUSDTStrategy",
        "symbol": "XRPUSDT",
        "timeframe": "1h",
