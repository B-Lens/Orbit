"""Hourly breakout strategy for BNBUSDT."""
...
@dataclass
class BNBUSDTStrategy(Strategy):
    """Trade hourly BNBUSDT breakouts in the direction of the prevailing trend.

    Parameters tuned via grid search on 2 years of Binance Futures hourly data
    yielding robust positive expectancy.
    """
    ...
    def generate_signals(
        ...
        # In a real environment, chart_path_raw is a path to a generated chart image. 
        # For simplicity, we can pass None or generate_chart.
        try:
