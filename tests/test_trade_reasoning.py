...
def test_exit_quantity_accepts_binary_float_rounding_noise() -> None:
    closing_quantity = 0.27999999999999997

    assert _quantity_is_complete(closing_quantity, 0.28)
    assert not _quantity_is_complete(0.27, 0.28)
