...
function CommandCenterPage() {
  ...
  const moveClosedTradeDay = (offset: number) => { const next = new Date(closedTradeDay); next.setDate(next.getDate() + offset); selectClosedTradeDay(next); };
