...
type CommandCenter = { generated_at: string; runtime: RuntimeState; positions: Position[]; signals: Signal[]; sentiment: Sentiment; sentiment_history: SentimentHistory[]; risk_execution: RiskExecution; logs: LogEntry[]; exceptions: ExceptionEntry[]; older_exception_count: number };
